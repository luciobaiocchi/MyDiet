...
drop database if exists SCHEMA_ER_definitivo_logico;
create database SCHEMA_ER_definitivo_logico;
...
create table RECENSIONE (
                            Id_recensione varchar(255) not null,
                            Username varchar(255) not null,
...
create table SVILUPPO (
                          SVI_Username varchar(255) not null,
                          SVI_Data_inizio date not null,
                          SVI_Nome varchar(255) not null,
                          SVI_Durata_mesi int not null,
                          constraint ID_SVILUPPO_ID primary key (SVI_Username, SVI_Data_inizio, SVI_Nome, SVI_Durata_mesi),
                          foreign key (SVI_Username, SVI_Durata_mesi) references TARIFFA (Username, Durata_mesi),
                          foreign key (SVI_Username) references NUTRIZIONISTA (Username)
);
...
create table ASSUNZIONE (
                            ...
                            Nome varchar(255) not null,
                            IdIntegratore varchar(255) not null,
                            constraint ID_ASSUNZIONE_ID primary key (IdIntegratore, Username, Data_inizio, Nome),
...
create unique index FKREC_NUT_IND
    on RECENSIONE (Username);

create unique index FKREC_CLI_IND
